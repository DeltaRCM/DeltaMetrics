...
channel_mask = dm.mask.ChannelMask(rcm8cube['velocity'].data[-1, :, :], rcm8cube['eta'].data[-1, :, :])
centerline_mask = dm.mask.CenterlineMask(channel_mask)
edge_mask = dm.mask.EdgeMask(rcm8cube['eta'].data[-1, :, :])
shore_mask = dm.mask.ShorelineMask(rcm8cube['eta'].data[-1, :, :])
...
ax0.imshow(rcm8cube['eta'].data[-1, :, :])
